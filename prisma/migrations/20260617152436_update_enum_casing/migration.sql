/*
  ...
  - The values [Applied,Interviewing,Offer,Rejected] on the enum `Status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Status_new" AS ENUM ('APPLIED', 'INTERVIEWING', 'OFFER', 'REJECTED');
